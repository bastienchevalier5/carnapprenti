            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('accueil') }}">
                        <img src="{{ asset('images/carnapprenti-removebg-preview.png') }}" alt="Mon Logo" class="w-50 mt-3">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('profile.edit')" :active="request()->routeIs('accueil')">
                        Mon Profil
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('livret.index')" :active="request()->routeIs('accueil')">
